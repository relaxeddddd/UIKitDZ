...
class PostsViewController: UIViewController {
    ...
    func setupTableView() {
        tableView.register(StoriesCell.self, forCellReuseIdentifier: "StoriesCell")
        tableView.register(PostCell.self, forCellReuseIdentifier: "PostCell")
        tableView.register(RecomindationCell.self, forCellReuseIdentifier: "RecomindationCell")
...
extension PostsViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case let .recomendation(info):
            guard let cell = tableView.dequeueReusableCell(
                withIdentifier: "RecomindationCell",
                for: indexPath
